...
public class CarrotDecorator implements DayViewDecorator {

    private Activity activity;

    public CarrotDecorator(Activity activity){
    ...
    public void decorate(DayViewFacade view) {
        view.setBackgroundDrawable(activity.getResources().getDrawable( R.mipmap.carrot_transparant ));
    }
}
